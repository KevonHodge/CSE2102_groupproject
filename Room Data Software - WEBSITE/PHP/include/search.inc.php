...
<div class="Test">
    ...
    <?php endif ?>
      ...
      <input class="Big-button" value="Search" type="submit" name="search">


       

      
<!--This is the search Engine's Equippment Dropdown list tab-->
  <dl class="dropdown"> 
              <div class="AC"> 
                <br><label class="A_C">Air-Conditioning Unit:Yes<input type="checkbox" name="ac" value="Yes">
                No<input type="checkbox" name="ac" value="No"></label>
                <label class="Room_id">Room Seats:<input type="text" name="No_of_seats" placeholder="Input Number"></label>
...
<!--This is the search Engine's Equippment R_type_dropdown list tab-->
...
<select class="Faculty">
    ...
    <option name = "fid" value="FNS">Faculty of Natural Science</option>
    <option name = "fid"value="FSS">Faculty of Social Science</option>
    <option name = "fid"value="FEH">Faculty of Education and Humanities</option>
    <option name = "fid"value="FET">Faculty of Engineering and Technology</option>
    <option name = "fid" value="FEES">Faculty of Earth and Environmental Sciences</option>
    <option name = "fid"value="FHS">Faculty of Health Sciences</option>
    <option name = "fid"value="SEBI">School of Entrepreneurship and Business Innovation</option>
    <option name = "fid" value="FAF">Faculty of Agriculture and Forestry</option>
</select>
