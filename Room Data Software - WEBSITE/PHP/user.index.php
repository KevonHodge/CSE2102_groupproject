...
<div class="Test">
    <?php endif ?>
    <a href="include/search.inc.php"><button type="button" class="block1">SEARCH</button></a>
    <a href="include/bookaroom.inc.php"><button type="button" class="block22">BOOK A ROOM</button></a>
</div> 
